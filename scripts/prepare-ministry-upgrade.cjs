...
const files=['ministry-operations.sql','pastoral-notes.sql','automatic-assignment.sql','export-permissions.sql','visitor-intake-journey.sql','contact-milestones.sql','ministry-finalize.sql','attendance-leaders-only.sql','shared-followup-workspace.sql'];
